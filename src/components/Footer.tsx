export default function Footer({ resetTest }: { resetTest: () => void }) {
  return (
    <footer className="border-t border-neutral-600 flex justify-center py-7 mt-10">
      <button
        className="bg-neutral-800 text-white flex gap-2 px-5 py-3 rounded-lg hover:bg-neutral-700 cursor-pointer transition hover:*:-rotate-360"
        onClick={() => resetTest()}
      >
        Restart Test
        <svg
